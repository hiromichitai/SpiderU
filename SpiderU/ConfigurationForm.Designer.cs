namespace SpiderU {
	partial class ConfigurationForm {
		...
		private void InitializeComponent() {
			...
			this.tableLayoutPanel1.Controls.Add(this.CSVEncodingComboBox, 1, 4);
			...
			// CSVEncodingComboBox
			// 
			this.CSVEncodingComboBox.FormattingEnabled = true;
			resources.ApplyResources(this.CSVEncodingComboBox, "CSVEncodingComboBox");
			this.CSVEncodingComboBox.Name = "CSVEncodingComboBox";
			// 
			// tabPage4
			// 
		...
		private System.Windows.Forms.ComboBox CSVEncodingComboBox;
	}
}