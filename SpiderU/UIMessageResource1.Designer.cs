...
namespace SpiderU {
    ...
    public class UIMessageResource {
        ...
        /// <summary>
        ///   Oscilloscope sends wrong data に類似しているローカライズされた文字列を検索します。
        /// </summary>
        public static string UIMSGOSCWRONGDATA {
            get {
                return ResourceManager.GetString("UIMSGOSCWRONGDATA", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   OWON&apos;s PDS series should be in Vectors mode, not Bitmap に類似しているローカライズされた文字列を検索します。
        /// </summary>
        public static string UIMSGPDSBMP {
            get {
                return ResourceManager.GetString("UIMSGPDSBMP", resourceCulture);
            }
        }
